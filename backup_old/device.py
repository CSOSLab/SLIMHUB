...
class Device:
    ...
    async def remove(self):
        ...
        try:
            ...
            # connected_devices.pop(self.config_dict['address'], None)
        except:
            pass
        finally:
            del self
        ...
        if service_name == 'sound':
            ...
            if char_name == 'rawdata':
                ...
                if not self.unitspace_queue.full():
                    ...
                    if unpacked_data_list[0] == 1:      #if the inference packet is "GridEye" packet - "GridEye" index is "1"
